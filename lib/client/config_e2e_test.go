...
func getClientConfigAndEraseBackend(config *api.CalicoAPIConfig) client.ConfigInterface {
	// Erase backend clean
...
var _ = Describe("with config option API tests", func() {
	DescribeTable("should handle default and inherited per node configuration",
		func(cfg *api.CalicoAPIConfig) {
			var err error
			var l string
			var cs client.ConfigLocation

			config := getClientConfigAndEraseBackend(cfg)
	...
	DescribeTable("should handle node to node mesh configuration",
		func(cfg *api.CalicoAPIConfig) {
			var err error
			var n bool

			// Erase backend clean
			testutils.CleanBackend(cfg)

			c, err := testutils.NewClient(cfg)
			Expect(err).NotTo(HaveOccurred())
			config := c.Config()
	...
	DescribeTable("should handle default AS number configuration",
		func(cfg *api.CalicoAPIConfig) {
			var err error
	...
	DescribeTable("should handle default IP in IP configuration",
		func(cfg *api.CalicoAPIConfig) {
			var err error
			var n bool
	...
	DescribeTable("should handle node IP in IP tunnel address",
		func(cfg *api.CalicoAPIConfig) {
			var err error
			var ip *net.IP
	...
	DescribeTable("should handle global felix config",
		func(cfg *api.CalicoAPIConfig) {
			var err error
			var value string
			var set bool
	...
	DescribeTable("should handle per-node felix config",
		func(cfg *api.CalicoAPIConfig) {
			var err error
			var value string
			var set bool
	...
	DescribeTable("should handle global BGP config",
		func(cfg *api.CalicoAPIConfig) {
			var err error
			var value string
			var set bool
	...
	DescribeTable("should handle per-node BGP config",
		func(cfg *api.CalicoAPIConfig) {
			var err error
			var value string
			var set bool
